...
namespace Common_Response_Caching_MediatR_dotnet.Persistence
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>().HasData(
                new Product("iPhone 16 Pro", "Apple's latest flagship smartphone with a ProMotion display and improved cameras", 999.99m),
        ...
        {
            optionsBuilder.UseInMemoryDatabase("commonworld_dotnet");
        }
    }
}
